...
\begin{exercise}
\color{red}
    Suppose that you have shown that whenever $X$ is true iff $Y$ is true, and you know that $Y$ is true iff $Z$ is true. Is this enough to show that $X, Y, Z$ are logically equivalent? Explain.
\end{exercise}
\begin{solution}
